...
//        $id = ($parent->getKeyName() === 'id') ? $id = $relation->startNodeIdentity() : $node->value($parent->getKeyName());
        $id = ($parent->getKeyName() === 'id') ? $id = $relation->startNodeIdentity() : $parent['attributes'][$parent->getKeyName()];
